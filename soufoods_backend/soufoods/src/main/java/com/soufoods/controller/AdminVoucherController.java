...
public class AdminVoucherController {
	...
	@PostMapping("/createDiscountCode")
	public ResponseEntity<?> createDiscountCode() {
		Map<String, Object> map = voucherService.createDiscountCode();
		return ResponseEntity.ok(map);
	}
	
	@PostMapping("")
	public ResponseEntity<?> addVoucher(Voucher voucher, @RequestParam("messageType") String messageType) {
		Map<String, Object> map = voucherService.addVoucher(voucher, messageType);
		return ResponseEntity.ok(map);
	}
