    ...
    if (filter) {
      ...
      filterTable.innerHTML += `
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" id="active-account" type="checkbox" key="active" value-checked="true" value-unchecked="false" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label" for="active-account" style="user-select: none;">Trạng thái tài khoản</label>
