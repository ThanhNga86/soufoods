    ...
    if (filter) {
      ...
      filterTable.innerHTML += `
        <div class="form-check form-switch">
          ...
          <label class="form-check-label label-filter">Trạng thái sản phẩm</label>
        </div>
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="activePd" value-checked="true" value-unchecked="false" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label label-filter">Trạng thái sản phẩm chi tiết</label>
        </div>
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="quantity" value-checked="1" value-unchecked="0" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label label-filter">Trạng thái lượng hàng</label>
        </div>
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="discount" value-checked="1" value-unchecked="0" role="switch" style="cursor: pointer; box-shadow: none;">
