    ...
    if (filter) {
      ...
      filterTable.innerHTML += `
        <div class="form-check form-switch">
          ...
          <label class="form-check-label label-filter">Trạng thái mã giảm giá</label>
        </div>
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="freeShip" value-checked="true" value-unchecked="false" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label label-filter">Trạng thái free ship</label>
        </div>
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="expiration" value-checked="1" value-unchecked="0" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label label-filter">Trạng thái thời hạn</label>
        </div>
