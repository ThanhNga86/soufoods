    ...
    if (filter) {
      ...
      filterTable.innerHTML += `
        <div class="form-check form-switch">
          ...
          <label class="form-check-label label-filter">Trạng thái đánh giá</label>
        </div>
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="rates" value-checked="1" value-unchecked="1" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label label-filter"><i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i></label>
        </div>
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="rates" value-checked="2" value-unchecked="2" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label label-filter">
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
          </label>
        </div>
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="rates" value-checked="3" value-unchecked="3" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label label-filter">
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
        ...
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="rates" value-checked="4" value-unchecked="4" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label label-filter">
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
        ...
        <div class="form-check form-switch">
          <input class="form-check-input input-filter" type="checkbox" key="rates" value-checked="5" value-unchecked="5" role="switch" style="cursor: pointer; box-shadow: none;">
          <label class="form-check-label label-filter">
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
            <i class="fa-solid fa-star star-review" style="color: rgb(248, 196, 74);"></i>
